...
_ = cmd_auth.command(cmd_auth_service_account, name="service-account")
_ = cmd_auth.command(cmd_login_register, name="register")
_ = cmd_auth.command(cmd_login_register_webapp, name="register-webapp")
_ = cmd_auth.command(cmd_auth_client_show, name="client-show")
_ = cmd_auth.command(cmd_auth_client_update, name="client-update")
_ = cmd_auth.command(cmd_auth_client_delete, name="client-delete")
