...
from bfabric_app_runner.cli.cmd_app_zip import cmd_app_zip_create_uv
...
cmd_app_zip = cyclopts.App(name="app-zip")
cmd_app_zip.command(cmd_app_zip_create_uv, name="create-uv")
app.command(cmd_app_zip)
