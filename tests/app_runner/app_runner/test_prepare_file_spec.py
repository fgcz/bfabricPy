...
from app_runner.input_preparation.prepare_file_spec import (
    prepare_file_spec,
...
def operation_copy_rsync(mocker):
    return mocker.patch("app_runner.input_preparation.prepare_file_spec._operation_copy_rsync", return_value=False)


@pytest.fixture
def operation_copy_scp(mocker):
    return mocker.patch("app_runner.input_preparation.prepare_file_spec._operation_copy_scp", return_value=False)


@pytest.fixture
def operation_copy_cp(mocker):
    return mocker.patch("app_runner.input_preparation.prepare_file_spec._operation_copy_cp", return_value=False)


@pytest.fixture
def operation_link_symbolic(mocker):
    return mocker.patch("app_runner.input_preparation.prepare_file_spec._operation_link_symbolic", return_value=False)
