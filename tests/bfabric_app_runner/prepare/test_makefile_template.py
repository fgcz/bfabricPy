...
class TestIsValidVersion:
    ...
    def test_valid_versions(self):
        ...
        valid_versions = ["1.0.0", "2.1.3", "1.0.0-alpha", "1.0.dev0"]
...
class TestGetAppRunnerDepString:
    ...
    def test_pypi_version_formatting(self):
        ...
        result = get_app_runner_dep_string("1.2.3")
        assert result == "bfabric-app-runner==1.2.3"
    ...
    def test_git_reference_formatting(self):
        ...
        result = get_app_runner_dep_string(git_ref)
        assert result == f"bfabric-app-runner@{git_ref}"
