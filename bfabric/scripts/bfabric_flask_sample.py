...
def add_dataset(projectid):
    obj = {'applicationid': 213, 'projectid': projectid, 'name':'test','description':'auto generated', 'status':'available'}
    ...
    try:
        ...
        #res=bfapp.save_object('workunit', {'id':wuid, 'status':'available'})
        print res
